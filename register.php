<?php
  ...
  if(isset($_POST['register'])) {
   ...
   if($con->query($sql) === True) {
      _set_alert('s', 'Registration was succesful. Login now');
      _redirect('login.php');
    } else {
...
<div class="header clearfix">
  ...
  <h3 class="text-muted">CODE9ja</h3>
</div>
  ...
  <form action="register.php" method="post" class="">
    ...
    <div class="card-footer clearfix">
      <p>Already a member? <a href="login.php">Login here</a></p>
        <p><button type="submit" name="register" class="btn btn-warning float-right">Register</button></p>
    </div>
  </form>
</div>
